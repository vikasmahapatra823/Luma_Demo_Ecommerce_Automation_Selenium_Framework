...
public class GenericActionObject {
    ...
    public static By productPriceOnCart(String product) {
        return By.xpath("//a[normalize-space(text())='" + product + "']/../../div[@class='product options']/..//span[@class='price']");
    }

    public static By cartSubtotal = By.xpath("//div[@class='subtotal']//span[@class='price']");
